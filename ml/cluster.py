...
if __name__ == "__main__":
    ...
    save_checkpoint_path = r"/cluster/home/magnufal/TDT4265/checkpoints/after_fine_search_13_04_26_300_epochs_from_baseline_weights.pth"
    ...
    optimizer_loop(model=model, train_loader=train_loader, val_loader=val_loader, save_path=save_checkpoint_path, epochs=300, lr=1e-2,
                   momentum=0.79, nesterov=True, weights=weights)